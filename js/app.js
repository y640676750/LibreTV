// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["zy360","huya","hongniu","liangzi","ruyi","wolong","mdzy","jinying","subo"]');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        selectedAPIs = ["zy360", "huya", "hongniu", "liangzi", "ruyi", "wolong", "mdzy", "jinying", "subo"];
